...
<ul class="contact-buttons" style="list-style: none; padding: 0; display: flex; flex-direction: column; gap: 1rem; align-items: center;">
  <li>
    {%
      include link.html
      type="email"
...
{%
  ...
  alt="Exterior view of Giltner Hall building"
