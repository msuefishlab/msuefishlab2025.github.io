...
<figure>
  <video class="video_float_right" src="/images/spawning_mar11.mp4" controls aria-label="Brienomyrus brachyistius electric fish spawning behavior">
    <p>Video description: A 30-second clip showing a pair of Brienomyrus brachyistius electric fish spawning in a laboratory tank, recorded several hours after nightfall. The fish repeatedly spawn near a tank partition over a 10-15 minute period.</p>
  </video>
  <figcaption class="sr-only">Video showing Brienomyrus brachyistius spawning behavior. The pair spawns repeatedly over 10-15 minutes near a tank partition.</figcaption>
</figure>
